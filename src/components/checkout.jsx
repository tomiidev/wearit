...
const Checkout = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(
        "Hubo un problema al enviar la orden. Por favor, inténtalo de nuevo.",
      );
          ...
          <div className="row justify-center mt-10 pt-10 ">
            ...
            <div className="col-lg-6 ml-auto p-3  rounded-sm bg-white text-left">
              <h6 className="py-4 px-2 bg-gray-100 mb-4 text-xs font-poppins">
                <span className="icon_tag_alt"></span>¿Te olvidaste de ingresar
                un cupón?
                <Link to="/cart" className="text-black ml-2 text-xs">
                  Clickea acá
                </Link>
              </h6>
              <h6 className="checkout__title mb-4 font-roboto">
                Detalle de factura
              </h6>
              <div className="row">
                ...
                <>
                  <div className="checkout__input mb-4">
                    <div className="flex w-full sm:w-2/5 items-center p-4 bg-white border-2 border-gray-300 rounded-sm shadow-sm hover:shadow-lg transition-shadow duration-300">
                      ...
                      <div className="ml-4">
                        <h3 className="text-sm font-poppins text-black">
                          <strong>Montevideo</strong>
                        </h3>
                        <p className="text-sm font-questrial text-gray-800">
                          Porongos 2419, 11200
                        </p>
                      </div>
                    </div>
            ...
            <div className="col-lg-4 bg-gray-100 pt-10">
              <div className="p-3  lg:min-h-screen flex flex-col">
                ...
                {paymentMethods.map((method) => (
                  ...
                  >
                    <div
                      className={`w-6 h-6 border-2 ${paymentMethod === method.value ? "border-gray-800 bg-black" : "border-gray-300"} 
                    ...
                    <span className="text-sm sm:text-lg text-gray-800 font-questrial">
                      {method.label}
                    </span>
                  </div>
                ))}
