...
const ProductIDV2 = () => {
    ...
    if (productTitle) {
      const foundProduct = productData.find(
        (item) =>
          ...
          decodeURIComponent(productTitle).toLowerCase(),
      );
  ...
  const handleVariantChange = (field, value) => {
    if (!product) return;
    const matchingVariant = product.variants.find((v) => v[field] === value);
  ...
  const addToCart = () => {
    ...
    const selectedVariant =
      product.variants.length > 0 ? product.variants[0] : {}; // Obtiene la primera variante o un objeto vacío
        ...
        <div className="product__details__pic min-h-screen bg-white  mt-10 pt-10">
          <div className="container-fluid min-h-[700px]">
            <div className="text-gray-600 text-lg text-left font-questrial">
              <NavLink
                to="/"
                className="text-gray-600 hover:text-gray-700 no-underline font-questrial"
              >
                Inicio
              </NavLink>
              <span className="mx-2">/</span>

              <span className="font-questrial text-gray-700">
                {product?.typeProduct}
              </span>
              <span className="mx-2">/</span>
              <span className="font-questrial text-black">
            ...
            <div className=" mx-auto  py-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 ">
                  ...
                  <div className="product__details__pic__item relative">
                    ...
                    {product?.variants.length > 0 ? (
                      <img
                        ...
                        src={
                          selectedVariant?.color ? product.image : product.image
                        }
                        alt="Producto"
                ...
                <ProductCarousel
                  ...
                  imagesAdded={product?.imagesAdded}
                  cambiarImagenPrincipalv={cambiarImagenPrincipalv}
                ...
                <div
                  ref={ref}
                  className={`space-y-4  text-left transition-all duration-500 ease-out ${
                    isVisible
                      ? "transform translate-x-0 opacity-100"
                      : "transform translate-x-full opacity-0"
                  }`}
                >
                  <h1 className="text-lg sm:text-2xl font-roboto  text-black capitalize">
                    ...
                    {product?.variants.length > 0 && (
                      <div>
                        <select
                          ...
                          onChange={(e) =>
                            handleVariantChange("dato_2_mul", e.target.value)
                          }
                  ...
                  <p className="text-black">
                    <strong>
                      Compartí este producto en tus redes sociales
                    </strong>
                  </p>
                  <div className="flex gap-2">
                    <WhatsappShareButton
                      title={product?.descripcion}
                      url={`https://wearit-silk.vercel.app/shop/${productoTipo}/${categoria}/${productTitle}`}
                    >
